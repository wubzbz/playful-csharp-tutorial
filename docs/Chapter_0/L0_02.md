...
[Visual Studio](#用-visual-studio) 和 [Visual Studio Code](#用-visual-studio-code) 都可以，请在它们之中 **二选一** 。如果你的系统是Linux，或者储存空间不充足，推荐用Visual Studio Code。
...
作为初学者，我们下载Community（社区版）就好了，它是免费的。然后看这个 [安装说明](https://learn.microsoft.com/zh-cn/visualstudio/install/install-visual-studio?view=vs-2022)。 **安装时会让你选工作负载，别忘了勾选“.NET桌面开发”**。请参考下图：
...
此时，界面的右侧展示了很多项目模板。在项目模板中找到名为 **“控制台应用”** ，而且**带有C#标签**的选项：
